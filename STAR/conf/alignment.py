...
class Alignment(Base):
    ...
    def __init__(self, args):
        ...
        self.net = "stackedHGnet_v2"
        self.nstack = 2
        self.loader_type = "alignment"
        self.data_definition = "ivslab"  # COFW, 300W, WFLW, ivslab
        self.test_file = "test.tsv"

        self.distill = False
        self.teacher_net = "stackedHGnet_v1"
        self.teacher_net_path = "../Models/best_model.pkl"
        self.temperature = 0.8
        self.alpha = 0.1
        self.teacher_use_AAM = True
        ...
        # ivslab
            ...
            self.edge_info = (
                (False, (0, 1, 2, 3, 4)),  # RightEyebrow
                (False, (5, 6, 7, 8, 9)),  # LeftEyebrow
            ...
            if self.norm_type in ['ocular', 'default']:
                self.nme_left_index = 19  # ocular
                self.nme_right_index = 28  # ocular
            elif self.norm_type == 'pupil':
            ...
            self.flip_mapping = (
                [0, 9], [1, 8], [2, 7], [3, 6], [4, 5],
                [14, 18], [15, 17],
                [19, 28], [20, 27], [21, 26], [22, 25], [23, 30], [24, 29],
                [31, 37], [32, 36], [33, 35], [44, 46], [43, 47], [50, 48], [41, 39], [42, 38],
            )
            self.image_dir = osp.join(self.image_dir, 'ivslab')
