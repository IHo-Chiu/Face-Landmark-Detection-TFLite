...
class DWsConv(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1, padding=1, relu=True, bn=True):
...
class CoordConvTh(nn.Module):
    ...
    def __init__(self, x_dim, y_dim, with_r, with_boundary,
        ...
        self.conv = DWsConv(in_channels=in_channels, out_channels=out_channels, *args, **kwargs)
...
class CoordConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, with_r=False, **kwargs):
        ...
        self.conv = DWsConv(in_channels, out_channels, **kwargs)
